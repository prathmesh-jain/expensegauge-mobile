...
export default function ForgotCredentials() {
    ...
    const handleRequestPasswordResetOTP = async () => {
        setError({ emailError: '', otpError: '', passwordError: '', confirmPasswordError: '', serverError: '' });
        if (!email) {
        ...
        setLoading(true);
        try {
            const response = await api.post('/user/forgotPassword/requestOtp', { email }); 
    ...
    const handleResetPassword = async () => {
        ...
        setLoading(true);
        try {
            const response = await api.post('/user/forgotPassword/reset', { email, otp, newPassword });
            Alert.alert('Success', response.data.message);
            setEmail('');
            setOtp('');
            setNewPassword('');
